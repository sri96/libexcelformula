...
#ifndef OPEN_PAREN_TOKEN_H
#define OPEN_PAREN_TOKEN_H
...
namespace ExcelFormula
{
    namespace Lexer
    {
        namespace Tokens
        {
            class OpenParenToken : public IExcelFormulaToken
            { 
            ...
            std::unique_ptr<IExcelFormulaToken> CreateOpenParenTokenInstance();
        };
    };
};
