...
#ifndef CLOSE_CURLY_PAREN_TOKEN_H
#define CLOSE_CURLY_PAREN_TOKEN_H
...
namespace ExcelFormula
{
    namespace Lexer
    {
        namespace Tokens
        {
            class CloseCurlyParenToken : public IExcelFormulaToken
            { 
            ...
            std::unique_ptr<IExcelFormulaToken> CreateCloseCurlyParenTokenInstance();
        };
    };
};
