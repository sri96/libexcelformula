...
std::pair<ParserError, ExcelFormulaParseTree> MockExcelFormulaParser::BuildParseTreeFromTokens(const std::vector<std::unique_ptr<ExcelFormula::IExcelFormulaToken>>& /*inputLexedTokens*/) const noexcept
{
