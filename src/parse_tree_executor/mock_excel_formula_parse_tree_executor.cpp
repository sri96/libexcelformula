...
std::pair<RuntimeError, std::wstring> MockExcelFormulaParseTreeExecutor::ExecuteParseTree(ExcelFormula::Parser::IExcelFormulaParseTree& /*inputParseTreeToExecute*/) const noexcept
{
